package com.troy.common.rocketmq.iterator;
...
/**
 * @Auther: zhuqing
 * @Date: 2023/8/7 11:11:49
 * @Description: 消息列表分割器类
 * @Version: 1.0.0
 */
public class ListSplitter<T extends BaseMqMessage> implements Iterator<List<T>> {
