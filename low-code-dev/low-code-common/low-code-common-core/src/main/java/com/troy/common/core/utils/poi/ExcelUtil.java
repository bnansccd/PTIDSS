...
import com.troy.common.core.anotation.Excels;
...
import com.troy.common.core.utils.file.ImageUtils;
...
public class ExcelUtil<T> {
    ...
    public static byte[] writeExcel(List datas, Class clazz) {
    ...
    public byte[] exportExcel(List<T> list, String sheetName, String title) {
        this.init(list, sheetName, title, Excel.Type.EXPORT);
