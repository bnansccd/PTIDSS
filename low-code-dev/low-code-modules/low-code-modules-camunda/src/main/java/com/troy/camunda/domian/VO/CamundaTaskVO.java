...
public class CamundaTaskVO implements Serializable {
    ...
    private CamundaCommentVO comment;
    ...
    public CamundaCommentVO getComment() {
        return comment;
    }

    public void setComment(CamundaCommentVO comment) {
