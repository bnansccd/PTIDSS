...
/**
 * @Auther: zhuqing
 * @Date: 2022/8/15 17:17:02
 * @Description: GenTableColumnVO
 * @Version: 1.0.0
 */
@ApiModel(description = "代码生成业务字段VO")
public class GenTableColumnVO extends BaseVO {
    ...
    public static boolean isSuperColumn(String javaField) {
        return StringUtils.equalsAnyIgnoreCase(javaField,
                // BaseEntity
                "id" , "createId" , "createTime" , "modifyId" , "modifyTime" , "remark" , "delFlag");
    }
