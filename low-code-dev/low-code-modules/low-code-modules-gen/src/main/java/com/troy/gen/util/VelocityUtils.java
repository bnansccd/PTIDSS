...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTableVO genTable) {
        ...
        velocityContext.put("urlPath", UrlConstants.WEB_RESTFUL + UrlConstants.RESTFUL_VERSION_V1);
        velocityContext.put("dicts", getDicts(genTable));
//        if (genTable.isMain()) {
//            velocityContext.put("main", genTable.getMainTables());
//        }
    ...
    public static List<String> getTemplateList(String tplCategory) {
        ...
        templates.add("vm/java/operateDTO.java.vm");
    ...
    public static String getFileName(String template, GenTableVO genTable) {
        ...
        if (template.contains("sub-domain.java.vm") && StringUtils.equals(GenConstants.TPL_SUB, genTable.getTplCategory())) {
            ...
            fileName = StringUtils.format("{}/controller/web/{}Controller.java", javaPath, className);
        ...
        } else if (template.contains("operateDTO.java.vm")) {
            fileName = StringUtils.format("{}/domain/DTO/{}DTO.java", javaPath, className);
        } else if (template.contains("searchDTO.java.vm")) {
            fileName = StringUtils.format("{}/domain/DTO/{}SearchDTO.java", javaPath, className);
