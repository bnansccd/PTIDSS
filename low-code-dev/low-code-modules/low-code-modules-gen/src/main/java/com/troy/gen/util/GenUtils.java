...
import com.troy.gen.config.GenConfig;
...
public class GenUtils {
     ...
     * 初始化表信息
     */
    public static void initTable(GenTableEntity genTable, Long userId) {
    ...
    public static void initColumnField(GenTableColumnEntity column, GenTableEntity table) {
        ...
        column.setCreateId(table.getCreateId());
        // 设置java字段名
