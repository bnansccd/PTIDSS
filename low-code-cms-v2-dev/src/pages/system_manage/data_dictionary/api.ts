...
export const ApibaseURL = "/system/api/web/v1/sysDict";
...
export const childrenInitParams: AjaxParams /*初始化入参*/ = {
    dictName: "",
    current: 1,
    size: Number(window.sessionStorage.getItem("Globalpagesize")) || 10,
    parentId: "",
...
export async function apiGetList(ajaxParams: AjaxParams) {
    const response: Response = await $api.get(`${ApibaseURL}/page`, {
        params: ajaxParams,
