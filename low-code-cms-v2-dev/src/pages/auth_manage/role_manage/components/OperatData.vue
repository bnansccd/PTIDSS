...
import { apiPostAdd, apiGetRoleDetails, apiPutEdit, apiGetSort } from "./api";
...
<template>
    <GlobalElDialog :="$attrs" @close="closeDialog">
        <GlobalElForm
            ref="refElForm"
            label-width="5vw"
            :model="ajaxParams"
        ...
        >
            ...
            <GlobalElFormItem label="是否是超管角色" prop="isSuper">
                <GlobalElSwitch
                    v-model="ajaxParams.isSuper"
                    active-value="1"
                    inactive-value="0"
                />
            </GlobalElFormItem>
